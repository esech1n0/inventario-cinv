...
export function InventoryClient({
  ...
  // Manejadores de actualización optimista
  ...
  function handleErrorRevert(errorMsg: string) {
    // Revertir recargando los items del servidor
    setBannerMessage({
      type: "error",
      text: errorMsg,
    });
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6">
      ...
      <div className="mt-6 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-3">
        <div className="rounded-2xl border border-border bg-card p-4 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xl font-bold text-foreground">{totalArticulos}</p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-border bg-card p-4 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-medium text-muted-foreground">Total de Unidades</p>
        ...
        <div className="col-span-2 sm:col-span-1 rounded-2xl border border-border bg-card p-4 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-medium text-muted-foreground">Módulos Activos</p>
      ...
      <div className="mt-6 space-y-4">
        ...
        {/* Pestañas de Módulos (Scroll horizontal en móvil) */}
      ...
      {/* Lista de Artículos (Mobile Cards + Desktop Table) */}
      <div className="mt-6">
            ...
            {filteredItems.map((item) => (
              ...
              >
                <div>
                  ...
                  {/* Detalle de Stock en TEXTO PLANO (Regla de Negocio: sin colores de alerta por stock) */}
