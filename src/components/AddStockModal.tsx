      ...
      <div className="animate-fade-in w-full max-w-lg rounded-t-3xl sm:rounded-2xl border border-border bg-card p-6 shadow-2xl">
        <div className="flex items-center justify-between pb-4 border-b border-border">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-lg font-bold text-foreground">Ingresar Stock (Entrada)</h2>
              <p className="text-xs text-muted-foreground">Añadir unidades recibidas al inventario</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-4">
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-foreground">Artículo a reabastecer</label>
            <select
              value={itemId}
              onChange={(e) => {
          ...
          {/* Cantidad a agregar */}
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-foreground">Cantidad de unidades a ingresar</label>
          ...
          {/* Motivo */}
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-foreground">Motivo del ingreso *</label>
            <input
              type="text"
              required
              value={motive}
